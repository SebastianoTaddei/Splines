...
Fork of [Splines](https://github.com/ebertolazzi/Splines) by Enrico Bertolazzi.
...
```bash
git clone --branch stable --depth 1 https://github.com/SebastianoTaddei/Splines.git
cd Splines
ruby setup.rb
rake
```
